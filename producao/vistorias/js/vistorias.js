        ...
        <div class="d-flex justify-content-between">
            ...
            <div>
                ...
                <div class="font-weight-bold">
                    ...
                    <i class="fa fa-calendar text-${badge}"></i>
...
function actualizarContadores(dados){
    ...
    document.getElementById("totalVencidas").textContent =
        dados.vencidas.length;

    document.getElementById("totalProgramadas").textContent =
        dados.programadas.length;

    document.getElementById("totalAgendadas").textContent =
        dados.agendadas.length;
...
function actualizarResumo(dados){
    ...
    document.getElementById("totalRegistos").textContent =
        total;

    document.getElementById("totalVencidasResumo").textContent =
        dados.vencidas.length;

    document.getElementById("totalProgramadasResumo").textContent =
        dados.programadas.length;

    document.getElementById("totalAgendadasResumo").textContent =
        dados.agendadas.length;
...
function exportarPDF(lista, titulo) {
    ...
    doc.autoTable({
        ...
        foot: [[
            ...
            totalLista(lista).toLocaleString(
...
function inicializarExportacaoPDF() {
    ...
    const pdfVencidas =
        document.getElementById("pdfVencidas");

    if (pdfVencidas) {

        pdfVencidas.addEventListener(
    ...
    const pdfProgramadas =
        document.getElementById("pdfProgramadas");

    if (pdfProgramadas) {

        pdfProgramadas.addEventListener(
    ...
    const pdfAgendadas =
        document.getElementById("pdfAgendadas");

    if (pdfAgendadas) {

        pdfAgendadas.addEventListener(
